...
First off, thank you for considering contributing to `FastrAPI`. This guide details all the general information that one should know before contributing to the project.
...
- Do mention (@ppmpreetham) the project maintainer if your PR isn't reviewed within a few days.
